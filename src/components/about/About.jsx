...
const About = () => {
    return (
        <section className="about section" id="about">
            ...
            <span className="section__subtitle">Senior Mathematical Engineering student eager to advance a career in Backend Programming. Coding skills
                        have been developed through various projects and internships. Active roles in projects have enhanced teamwork
                        and communication skills.</span>
            ...
            <div className="about__container container grid">
                ...
                <div className="qualification__sections">
                    <div className="qualificaiton__content qualificaiton__content-active">
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Intern</h3>
                                <span className="qualification__subtitle"> YTU </span>
                    ...
                    <div className="qualificaiton__content ">
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Intern</h3>
                                <span className="qualification__subtitle"> YTU </span>
