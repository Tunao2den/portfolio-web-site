                        ...
                        <div className="projects__modal-content">
                            ...
                            <ul className="projects__modal-projects grid">
                                ...
                                <li className="projects__modal-project">
                                    ...
                                    <a href="https://github.com/Tunao2den/http-web-server" className="projects__modal-link">Check out the source code</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="projects__content">
                    ...
                    <div className={toggleState === 2 ? "projects__modal active-modal" : "projects__modal"}>
                        <div className="projects__modal-content">
                            ...
                            <p className="projects__modal-description">Todo App developed with Java, Spring-Boot, Spring-Security, React</p>
                ...
                <div className="projects__content">
                    ...
                    <div className={toggleState === 3 ? "projects__modal active-modal" : "projects__modal"}>
                        <div className="projects__modal-content">
                            ...
                            <p className="projects__modal-description">RESTful API which fetches currency exchange data</p>
                            <ul className="projects__modal-projects grid">
                                <li className="projects__modal-project">
                                    <i className="uil uil-check-circle projects__modal-icon"></i>
